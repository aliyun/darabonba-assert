...
template<typename T>
bool isinstance(boost::any value) {
  if (typeid(shared_ptr<T>) == value.type()) {
    return true;
  } else if (typeid(T) == value.type()) {
    return true;
...
void Assert(boost::any val1, boost::any val2) {
  ...
  if (isinstance<map<string, boost::any>>(val1) && isinstance<map<string, boost::any>>(val2)) {
  ...
  } else if (isinstance<vector<boost::any>>(val1) && isinstance<vector<boost::any>>(val2)) {
    ...
    Darabonba_Assert::Client::equal(cast_any<string>(val1),
                                    cast_any<string>(val2),
                                    msg);
  } else if (isinstance<int>(val1) && isinstance<int>(val2)) {
    Darabonba_Assert::Client::equal(cast_any<int>(val1),
                                    cast_any<int>(val2),
                                    msg);
  } else if (isinstance<long>(val1) && isinstance<long>(val2)) {
    Darabonba_Assert::Client::equal(cast_any<long>(val1),
                                    cast_any<long>(val2),
                                    msg);
    ...
    Darabonba_Assert::Client::equal(cast_any<double>(val1),
                                    cast_any<double>(val2),
                                    msg);
  } else if (isinstance<bool>(val1) && isinstance<bool>(val2)) {
    Darabonba_Assert::Client::equal(cast_any<bool>(val1),
                                    cast_any<bool>(val2),
                                    msg);
  } else if (isinstance<bool>(val1) && isinstance<bool>(val2)) {
    Darabonba_Assert::Client::equal(cast_any<bool>(val1),
